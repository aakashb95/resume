...
\textit{Project Engineer (NLP R\&D) - Applied AI Group} \hfill Mar 2021 - Present\\
\vspace{-1mm}
\begin{itemize} \itemsep 1pt
    ...
    \item Worked on synthetic data generation, built model for Indian demographic data using phonetic similarity and blocking mechanisms to remove potential duplicates by \textbf{reducing comparisons by 98\%}.
    \item Working on end-to-end 360-degree profiling of a person from unstructured text. Using BERT based model for relation extraction, building custom dataset for said task.
...
\vspace{-1mm}
\begin{itemize} \itemsep 1pt
    \item Worked on Oracle Data Integrator (ODI) for data migration from Oracle DB to Microsoft SQL Server and Java Message Service to XML to Oracle DB for a retail client based out of the middle-east.
...
\begin{itemize} \itemsep 1pt
    ...
    \item Built a voting classifier based on PCA+CNN, Cosine Similarity+XGBoost, UMAP+LGBM to obtain a robust binary classifier which had an \textbf{f1-score of 0.98} and \textbf{accuracy of 0.97} .
          \\
\end{itemize}
\vspace*{2mm}
...
\begin{itemize}
    ...
    \item Git, Flask, FastAPI, Streamlit, Docker
\end{itemize}
